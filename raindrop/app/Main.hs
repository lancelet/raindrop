...
renderHashSymbol :: IO ()
renderHashSymbol = do
  let (img, events) = renderPath (Size 16 16) (Epsilon 1e-5) hashSymbol
...
renderTri :: IO ()
renderTri = do
  let (img, events) = renderPath (Size 4 4) (Epsilon 1e-5) tri
...
tri :: Path Float
tri = Path [Loop [P 1.0 1.0, P 3.0 0.5, P 2.5 3.0]]
